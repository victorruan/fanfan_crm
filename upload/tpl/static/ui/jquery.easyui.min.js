...
for(var j=0;j<_e7;j++){
//$("<span class=\"tree-indent\"></span>").prependTo(_e9);//填补tree子菜单前面空格
}
}
};
};
...
var _19e=$("<div class=\"panel-header\"><div class=\"panel-title\">&nbsp;<img src='"+_ROOT_PATH+"tpl/static/ui/images/32/sign_in.png' style='width:16px; height:16px; vertical-align: middle;'/>&nbsp;"+opts.title+"</div></div>").prependTo(_19d);
if(opts.iconCls){
