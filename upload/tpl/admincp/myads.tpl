...
<!--{if $a eq "run"}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：系统设置<span>&gt;&gt;</span>广告管理</p></div>
  <div class="main-cont">
...
<!--{if $a eq "add"}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：系统设置<span>&gt;&gt;</span>添加广告</p></div>
  <div class="main-cont">
	...
	<table cellpadding='1' cellspacing='2' class='tab'>
	  ...
	  <tr>
		...
		<td class='hback'><input type="text" name="uploadfiles" id="uploadfiles" class="input-txt" value="" />  <span id='duploadfiles' class='f_red'></span></td>
	  </tr>
	  <tr>
...
<!--{if $a eq "edit"}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：系统设置<span>&gt;&gt;</span>编辑广告</p></div>
  <div class="main-cont">
	...
	<table cellpadding='1' cellspacing='2' class='tab'>
	  ...
	  <tr>
		<td class='hback_1'>图片/Flash地址  <span class="f_red">*</span></td>
		<td class='hback'><input type="text" name="uploadfiles" id="uploadfiles" class="input-txt" value="<!--{$myads.normbody.uploadfiles}-->" />  <span id='duploadfiles' class='f_red'></span></td>
	  </tr>
	  <tr>
		<td class='hback_1'>广告宽  <span class="f_red"></span></td>
