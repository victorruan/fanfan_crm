...
$(function () {
    ...
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            series: [{
                name: '收支：收入',
                data: [<!--{foreach name=flag from=$data item=volist}--><!--{$volist.inamount}--><!--{if !$smarty.foreach.flag.last}-->,<!--{/if}--><!--{/foreach}-->]
            },{
				name: '收支：支出',
				data: [<!--{foreach name=flag from=$data item=volist}--><!--{$volist.outamount}--><!--{if !$smarty.foreach.flag.last}-->,<!--{/if}--><!--{/foreach}-->]
			}]
        });
    });
