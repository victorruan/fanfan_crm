...
<!--{if $a eq "run"}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：财务管理<span>&gt;&gt;</span>财务参数</p></div>
  <div class="main-cont">
...
<!--{if $a eq "add"}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：财务管理<span>&gt;&gt;</span>添加财务参数</p></div>
  <div class="main-cont">
	...
	<table cellpadding='1' cellspacing='1' class='tab'>
	  ...
	  <tr>
		...
		<td class='hback'><input type="text" name="paramvalue" id="paramvalue" class="input-150" />  <span id='dparamvalue' class='f_red'></span> </td>
	  </tr>
	  <tr>
...
<!--{if $a eq "edit"}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：财务管理<span>&gt;&gt;</span>编辑财务参数</p></div>
  <div class="main-cont">
	...
	<table cellpadding='1' cellspacing='1' class='tab'>
	  ...
	  <tr>
		<td class='hback_1'>参数名称 <span class="f_red">*</span> </td>
		<td class='hback'><input type="text" name="paramvalue" id="paramvalue" class="input-150" value="<!--{$paramter.paramvalue}-->" />  <span id='dparamvalue' class='f_red'></span> </td>
	  </tr>
	  <tr>
		<td class='hback_1'>排序 </td>
