  ...
  <div class="main-cont">
	...
	<table cellpadding='3' cellspacing='3' class='tab'>
      ...
      <tr>
		...
		<td class='hback'><input type="text" name="email" id="email" class="input-100" /> <span class='f_red' id="demail"></span></td>
	  </tr>
      <tr>
		<td class='hback_1'>手机：<span class='f_red'>*</span></td>
		<td class='hback'><input type="text" name="mobile" id="mobile" class="input-100" /> <span class='f_red' id="dmobile"></span></td>
	  </tr>
	  <tr>
...
<div class="main-wrap">
  ...
  <div class="main-cont">
    ...
    <form name="myform" id="myform" method="post" action="<!--{$cpfile}-->?c=admin" onsubmit='return checkformedit();' />
	...
	<table cellpadding='3' cellspacing='3' class='tab'>
      ...
      <tr>
		<td class='hback_1'>邮箱：<span class='f_red'>*</span></td>
		<td class='hback'><input type="text" name="email" id="email" class="input-100" value="<!--{$admin.email}-->"/> <span class='f_red' id="demail"></span></td>
	  </tr>
      <tr>
		<td class='hback_1'>手机：<span class='f_red'>*</span></td>
		<td class='hback'><input type="text" name="mobile" id="mobile" class="input-100" value="<!--{$admin.mobile}-->" /> <span class='f_red' id="dmobile"></span></td>
	  </tr>
	  <tr>
