...
function select_goods(sortid,goodsid,sid,gdname,norms, price,oprice,discount) {
    window.parent.$('#sitem_gid_'+sortid).val(goodsid);
	window.parent.$('#sitem_sid_'+sortid).val(sid);
	window.parent.$('#sitem_id_'+sortid).html(goodsid);
	window.parent.$('#sitem_name_'+sortid).html(gdname);
	window.parent.$('#sitem_norms_'+sortid).html(norms);
	window.parent.$('#sitem_normsstr_'+sortid).val(norms);
	window.parent.$('#sitem_price_'+sortid).val(price);
	window.parent.$('#sitem_oprice_'+sortid).val(oprice);
	window.parent.$('#sitem_discount_'+sortid).val(discount);
	window.parent.$('#sitem_num_'+sortid).val(1);
