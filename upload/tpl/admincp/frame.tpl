...
color: White;">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" height="55px">
    <tr>
      ...
      <td></td>
      <td align="right" style="padding-right:10px;"><p> 
      <!--{X::$wrap_admin['adminname']}-->[<!--{if X::$wrap_admin['groupname']}--><!--{X::$wrap_admin['groupname']}--><!--{else}-->管理员<!--{/if}-->]欢迎您],
      [登录时间：<!--{X::$wrap_admin['lasttime']|date_format:"%Y-%m-%d %H:%M:%S"}-->]
      [登录次数：<!--{X::$wrap_admin['logintimes']}-->]
       <a href="javascript:addTab('修改密码', 'settings', '<!--{$cpfile}-->?c=admin&a=editpassword')" style="color:#FFFFFF">[修改密码]</a> <a href="<!--{$cpfile}-->?c=login&a=logout" style="color:#FFFFFF">[退出]</a>
       </p></td>
    </tr>
  </table>
</div>
    ...
    <div data-options="region:'center'" style="padding: 3px;">
      <table>
        <tr>
          ...
          <td><a href="javascript:remove()">关闭所有选项卡</a></td>
        </tr>
      </table>
    </div>
  ...
  <div class="easyui-accordion" data-options="fit:true,border:false,animate:false">
    <div title="产品管理" style="padding: 10px; overflow: auto;" data-options="selected:true"  class="tree">
      <ul>
        ...
        <li onClick="addTab('产品属性', 'product_169', '<!--{$cpfile}-->?c=modattr')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/product_169.png' alt='产品属性' style="vertical-align: middle;" /> 产品属性 </li>
         <li onClick="addTab('产品规格', 'product_169', '<!--{$cpfile}-->?c=norms')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/product_169.png' alt='产品规格' style="vertical-align: middle;" /> 产品规格 </li>
      </ul>
    </div>
    ...
    <div title="客户管理" style="padding: 10px" class="tree">
      <ul>
        ...
        <li onClick="addTab('客户设置', 'customers', '<!--{$cpfile}-->?c=setting&a=user')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/customers.png' alt='客户设置' style="vertical-align: middle;" /> 客户设置</li>
        
        <li onClick="addTab('客户组设置', 'customers', '<!--{$cpfile}-->?c=corpgroup')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/customers.png' alt='客户组设置' style="vertical-align: middle;" /> 客户组设置</li>
        <li onClick="addTab('现金记录', 'customers', '<!--{$cpfile}-->?c=money')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/customers.png' alt='现金记录' style="vertical-align: middle;" /> 现金记录</li>
        
        <li onClick="addTab('产品评论', 'customers', '<!--{$cpfile}-->?c=comment')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/customers.png' alt='产品评论' style="vertical-align: middle;" /> 产品评论 </li>
        <li onClick="addTab('留言列表', 'customers', '<!--{$cpfile}-->?c=guestbook')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/customers.png' alt='留言列表' style="vertical-align: middle;" /> 留言列表</li>
      </ul>
    </div>
    ...
    <div title="系统管理" style="padding: 10px" class="tree">
      <ul>
        ...
        <li onClick="addTab('图片设置', 'settings', '<!--{$cpfile}-->?c=setting&a=upload')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/settings.png' alt='图片设置' style="vertical-align: middle;" /> 图片设置 </li>
      </ul>
    </div>
    <div title="网站管理" style="padding: 10px" class="tree">
      <ul>
      	 <li onClick="addTab('网站设置', 'home2', '<!--{$cpfile}-->?c=setting&a=web')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/home2.png' alt='网站设置' style="vertical-align: middle;" /> 网站设置 </li>
        <li onClick="addTab('底部信息', 'home2', '<!--{$cpfile}-->?c=setting&a=footer')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/home2.png' alt='底部信息' style="vertical-align: middle;" /> 底部信息 </li> 
        <li onClick="addTab('安全设置', 'home2', '<!--{$cpfile}-->?c=setting&a=safety')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/home2.png' alt='安全设置' style="vertical-align: middle;" /> 安全设置</li>
        <li onClick="addTab('HTML标签', 'home2', '<!--{$cpfile}-->?c=htmllabel')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/home2.png' alt='HTML标签' style="vertical-align: middle;" /> HTML标签</li>
        <li onClick="addTab('首页SEO', 'home2', '<!--{$cpfile}-->?c=setting&a=seo')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/home2.png' alt='首页SEO' style="vertical-align: middle;" /> 首页SEO</li>
        <li onClick="addTab('广告版位', 'home2', '<!--{$cpfile}-->?c=zone')"> 
        <img src='<!--{$urlpath}-->tpl/static/ui/images/16/home2.png' alt='广告版位' style="vertical-align: middle;" /> 广告版位</li>
        <li onClick="addTab('广告管理', 'home2', '<!--{$cpfile}-->?c=myads')">
        <img src='<!--{$urlpath}-->tpl/static/ui/images/16/home2.png' alt='广告管理' style="vertical-align: middle;" /> 广告管理</li>
      </ul>
    </div>
    <div title="界面管理" style="padding: 10px" class="tree">
      <ul>
        <li onClick="addTab('设置模板', 'photography', '<!--{$cpfile}-->?c=skin')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/photography.png' alt='设置模板' style="vertical-align: middle;" /> 设置模板 </li>
        <li onClick="addTab('模板文件', 'photography', '<!--{$cpfile}-->?c=templet')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/photography.png' alt='模板文件' style="vertical-align: middle;" /> 模板文件 </li>
      </ul>
    </div>
    <div title="扩展管理" style="padding: 10px" class="tree">
      <ul>
        <li onClick="addTab('清除编译文件', 'communication', '<!--{$cpfile}-->?c=setting&a=clearcompiled')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/communication.png' alt='清除编译文件' style="vertical-align: middle;" /> 清除编译文件</li>
        <li onClick="addTab('插件列表', 'communication', '<!--{$cpfile}-->?c=plugin')"> <img src='<!--{$urlpath}-->tpl/static/ui/images/16/communication.png' alt='插件列表' style="vertical-align: middle;" /> 插件列表</li>
