...
if (!in_array($c, 
    array(
        ...
        'marketing','statistical','quoted','report','product','guide','mailtpl',
        'deliverycorp','modattr','corpgroup','comment','guestbook','htmllabel',
        'zone','myads','skin','templet','plugin','money','norms'
    ))) {
